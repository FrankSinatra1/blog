...
require_once "../bd/connection.php";
	...
	$sql="INSERT INTO `posts` (title,text, categories, author, datetime, img) VALUES ('$title','$text', '$categories', '$author', '$dateAdd', '$namefile')";
	...
	echo '<img src="images/'.$result['filename'].'">';
?>